...
export async function up(knex) {
  await knex.raw(`
    ...
    VALUES
      ...
      ('vector_tiles','read','{"_and":[{"permission_type":{"_eq":"roles+public"}}]}','{}','layer_id,layer_name,geometry_type,bounds,minzoom,maxzoom,layer_alias,preview,description,category,hover_popup_columns,click_popup_columns,image_columns,active,fill_style,line_style,circle_style,symbol_style'),
      ('symbol','read','{}','{}','*'),
      ('raster_tiles','read','{"_and":[{"permission_type":{"_eq":"roles+public"}}]}','{}','layer_id,bounds,minzoom,maxzoom,terrain_rgb,layer_alias,preview,description,category,active,visible'),
      ('raster_overlays','read','{"_and":[{"permission_type":{"_eq":"roles+public"}}]}','{}','layer_id,bounds,image,legend_image,layer_alias,category,active,visible'),
      ('line','read','{}','{}','*'),
      ('fill','read','{}','{}','*'),
      ...
      ('circle','read','{}','{}','*'),
      ('categories','read','{}','{}','*'),
      ('three_d_tiles','read','{"_and":[{"permission_type":{"_eq":"roles+public"}}]}','{}','layer_id,layer_alias,preview,description,category,active,visible,opacity,point_size,point_color'),
    ...
    AS $BODY$
      BEGIN
        ...
        VALUES
          ...
          (NEW.id,'vector_tiles','read','{"_and":[{"permission_type":{"_in":["roles","roles+public"]}},{"allowed_roles":{"directus_roles_id":{"_eq":"$CURRENT_ROLE"}}}]}','{}','layer_id,layer_name,geometry_type,bounds,minzoom,maxzoom,layer_alias,preview,description,category,hover_popup_columns,click_popup_columns,image_columns,active,fill_style,line_style,circle_style,symbol_style'),
          (NEW.id,'symbol','read','{}','{}','*'),
          (NEW.id,'raster_tiles','read','{"_and":[{"permission_type":{"_in":["roles","roles+public"]}},{"allowed_roles":{"directus_roles_id":{"_eq":"$CURRENT_ROLE"}}}]}','{}','layer_id,bounds,minzoom,maxzoom,terrain_rgb,layer_alias,preview,description,category,active,visible'),
          (NEW.id,'raster_overlays','read','{"_and":[{"permission_type":{"_in":["roles","roles+public"]}},{"allowed_roles":{"directus_roles_id":{"_eq":"$CURRENT_ROLE"}}}]}','{}','layer_id,bounds,image,legend_image,layer_alias,category,active,visible'),
          (NEW.id,'line','read','{}','{}','*'),
          (NEW.id,'fill','read','{}','{}','*'),
          ...
          (NEW.id,'three_d_tiles','read','{"_and":[{"permission_type":{"_in":["roles","roles+public"]}},{"allowed_roles":{"directus_roles_id":{"_eq":"$CURRENT_ROLE"}}}]}','{}','layer_id,layer_alias,preview,description,category,active,visible,opacity,point_size,point_color'),
