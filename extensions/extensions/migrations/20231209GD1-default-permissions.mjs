...
export async function up(knex) {
  await knex.raw(`
    ...
    VALUES
      ...
      ('symbol','read','{}','{}','*'),
      ('raster_tiles','read','{"_and":[{"active":{"_eq":true}},{"permission_type":{"_eq":"roles+public"}}]}','{}','layer_id,bounds,minzoom,maxzoom,terrain_rgb,layer_alias,category,default'),
    ...
    AS $BODY$
      BEGIN
        ...
        VALUES
          ...
          (NEW.id,'symbol','read','{}','{}','*'),
          (NEW.id,'raster_tiles','read','{"_and":[{"active":{"_eq":true}},{"permission_type":{"_in":["roles","roles+public"]}},{"allowed_roles":{"directus_roles_id":{"_eq":"$CURRENT_ROLE"}}}]}','{}','layer_id,bounds,minzoom,maxzoom,terrain_rgb,layer_alias,category,default'),
