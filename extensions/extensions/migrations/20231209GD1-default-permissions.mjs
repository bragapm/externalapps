export async function up(knex) {
  await knex.raw(`
    ...
    VALUES
      ('vector_tiles','read','{"_and":[{"active":{"_eq":true}},{"permission_type":{"_eq":"roles+public"}}]}','{}','layer_name,geometry_type,bounds,minzoom,maxzoom,layer_alias,preview,category,popup_columns,image_column,class_columns,default,cache_duration,fill_style,line_style,circle_style,symbol_style'),
      ('symbol','read','{}','{}','*'),
      ('raster_tiles','read','{"_and":[{"active":{"_eq":true}},{"permission_type":{"_eq":"roles+public"}}]}','{}','raster_id,bounds,minzoom,maxzoom,layer_alias,category,default'),
      ('raster_overlays','read','{"_and":[{"active":{"_eq":true}},{"permission_type":{"_eq":"roles+public"}}]}','{}','raster_id,bounds,image,legend_image,layer_alias,category,default'),
      ('line','read','{}','{}','*'),
      ('fill','read','{}','{}','*'),
    ...
    AS $BODY$
      BEGIN
        ...
        VALUES
          ...
          (NEW.id,'raster_overlays','read','{"_and":[{"active":{"_eq":true}},{"permission_type":{"_in":["roles","roles+public"]}},{"allowed_roles":{"directus_roles_id":{"_eq":"$CURRENT_ROLE"}}}]}','{}','raster_id,bounds,image,legend_image,layer_alias,category,default'),
          (NEW.id,'line','read','{}','{}','*'),
          (NEW.id,'fill','read','{}','{}','*'),
