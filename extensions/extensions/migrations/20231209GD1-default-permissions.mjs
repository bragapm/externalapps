...
export async function up(knex) {
  await knex.raw(`
    ...
    VALUES
      ('vector_tiles','read','{"_and":[{"active":{"_eq":true}},{"permission_type":{"_eq":"roles+public"}}]}','{}','layer_id,layer_name,geometry_type,bounds,minzoom,maxzoom,layer_alias,preview,category,hover_popup_columns,click_popup_columns,feature_detail_columns,image_column,class_columns,default,fill_style,line_style,circle_style,symbol_style'),
      ('symbol','read','{}','{}','*'),
