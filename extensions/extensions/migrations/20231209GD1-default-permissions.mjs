...
export async function up(knex) {
  await knex.raw(`
    ...
    VALUES
      ...
      ('raster_overlays','read','{"_and":[{"permission_type":{"_eq":"roles+public"}}]}','{}','layer_id,bounds,image,legend_image,layer_alias,category,active'),
      ('line','read','{}','{}','*'),
      ('fill','read','{}','{}','*'),
    ...
    AS $BODY$
      BEGIN
        ...
        VALUES
          ...
          (NEW.id,'symbol','read','{}','{}','*'),
          (NEW.id,'raster_tiles','read','{"_and":[{"permission_type":{"_in":["roles","roles+public"]}},{"allowed_roles":{"directus_roles_id":{"_eq":"$CURRENT_ROLE"}}}]}','{}','layer_id,bounds,minzoom,maxzoom,terrain_rgb,layer_alias,category,active'),
          (NEW.id,'raster_overlays','read','{"_and":[{"permission_type":{"_in":["roles","roles+public"]}},{"allowed_roles":{"directus_roles_id":{"_eq":"$CURRENT_ROLE"}}}]}','{}','layer_id,bounds,image,legend_image,layer_alias,category,active'),
          (NEW.id,'line','read','{}','{}','*'),
          (NEW.id,'fill','read','{}','{}','*'),
