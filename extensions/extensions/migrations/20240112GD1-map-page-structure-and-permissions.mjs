export async function up(knex) {
  await knex.raw(`
    CREATE TABLE IF NOT EXISTS public."map" (
      ...
      initial_map_view json NULL,
      CONSTRAINT map_pkey PRIMARY KEY (lang)
    );

    ALTER TABLE public."map" ADD CONSTRAINT map_user_updated_foreign FOREIGN KEY (user_updated) REFERENCES public.directus_users(id);
    ...
    VALUES ('map','subtitle',NULL,'input',NULL,NULL,NULL,false,false,6,'full',NULL,NULL,NULL,false,NULL,NULL,NULL),
      ...
      ('map','information',NULL,'input-rich-text-md','{"folder":"ffffffff-ffff-4fff-bfff-ffffffffffff"}',NULL,NULL,false,false,4,'full',NULL,NULL,NULL,false,NULL,NULL,NULL),
