export async function up(knex) {
  await knex.raw(`
    ...
    VALUES
      ...
      ('block_hero_single','image','file','file-image','{"folder":"ffffffff-ffff-4fff-bfff-ffffffffffff"}',NULL,NULL,FALSE,FALSE,NULL,'full',NULL,NULL,NULL,TRUE,NULL,NULL,NULL),
