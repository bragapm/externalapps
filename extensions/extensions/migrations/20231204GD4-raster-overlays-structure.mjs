...
export async function up(knex) {
  ...
  (
    ...
    (
      ...
      raster_overlays_raster_id uuid REFERENCES raster_overlays (raster_id)
        ON DELETE CASCADE,
    ...
    VALUES
      ('raster_overlays','raster_id','uuid','input',NULL,NULL,NULL,TRUE,FALSE,NULL,'full',NULL,NULL,NULL,FALSE,NULL,NULL,NULL),
      ...
      ('raster_overlays','permission_type',NULL,'select-dropdown','{"choices":[{"text":"Admin Only","value":"admin"},{"text":"Selected Roles","value":"roles"},{"text":"Selected Roles + Public","value":"roles+public"}]}',NULL,NULL,FALSE,FALSE,NULL,'half',NULL,NULL,NULL,FALSE,NULL,NULL,NULL),
      ...
      ('raster_overlays_directus_roles','id',NULL,NULL,NULL,NULL,NULL,FALSE,TRUE,NULL,'full',NULL,NULL,NULL,FALSE,NULL,NULL,NULL),
      ('raster_overlays_directus_roles','raster_overlays_raster_id',NULL,NULL,NULL,NULL,NULL,FALSE,TRUE,NULL,'full',NULL,NULL,NULL,FALSE,NULL,NULL,NULL),
    ...
    VALUES
      ...
      ('raster_overlays_directus_roles','directus_roles_id','directus_roles',NULL,NULL,NULL,'raster_overlays_raster_id',NULL,'nullify'),
      ('raster_overlays_directus_roles','raster_overlays_raster_id','raster_overlays','allowed_roles',NULL,NULL,'directus_roles_id',NULL,'delete');
  `);
}
