...
export async function up(knex) {
  await knex.raw(`
    ...
    VALUES
      ...
      ('vector_tiles','popup_columns','cast-json','select-multiple-checkbox','{"allowOther":true,"choices":[{"text":"ogc_fid","value":"ogc_fid"}]}',NULL,NULL,FALSE,FALSE,NULL,'full',NULL,NULL,NULL,FALSE,NULL,NULL,NULL),
