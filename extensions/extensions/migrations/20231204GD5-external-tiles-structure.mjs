export async function up(knex) {
  ...
  (
    external_tile_id uuid NOT NULL PRIMARY KEY,
    ...
    (
      ...
      external_tiles_external_tile_id uuid REFERENCES external_tiles (external_tile_id)
        ON DELETE CASCADE,
    ...
    VALUES
      ('external_tiles','external_tile_id','uuid','input',NULL,NULL,NULL,TRUE,FALSE,NULL,'full',NULL,NULL,NULL,FALSE,NULL,NULL,NULL),
      ...
      ('external_tiles','permission_type',NULL,'select-dropdown','{"choices":[{"text":"Admin Only","value":"admin"},{"text":"Selected Roles","value":"roles"},{"text":"Selected Roles + Public","value":"roles+public"}]}',NULL,NULL,FALSE,FALSE,NULL,'half',NULL,NULL,NULL,FALSE,NULL,NULL,NULL),
      ...
      ('external_tiles_directus_roles','id',NULL,NULL,NULL,NULL,NULL,FALSE,TRUE,NULL,'full',NULL,NULL,NULL,FALSE,NULL,NULL,NULL),
      ('external_tiles_directus_roles','external_tiles_external_tile_id',NULL,NULL,NULL,NULL,NULL,FALSE,TRUE,NULL,'full',NULL,NULL,NULL,FALSE,NULL,NULL,NULL),
    ...
    VALUES
      ...
      ('external_tiles_directus_roles','directus_roles_id','directus_roles',NULL,NULL,NULL,'external_tiles_external_tile_id',NULL,'nullify'),
      ('external_tiles_directus_roles','external_tiles_external_tile_id','external_tiles','allowed_roles',NULL,NULL,'directus_roles_id',NULL,'delete');
  `);
}
