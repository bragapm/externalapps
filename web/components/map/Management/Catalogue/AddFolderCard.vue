...
<template>
  <div
    class="flex flex-col justify-between gap-2 border border-neutral-700 bg-neutral-800 rounded-xs p-2 h-64"
  >
    <div class="flex flex-col flex-1 items-center justify-center py-8 gap-3">
      ...
      <div>
        <p class="line-clamp-3 text-neutral-50 text-center">Create a Folder</p>
        <p class="line-clamp-3 text-neutral-400 text-sm text-center">
          Datasets uploaded by User will be contained in a Folder.
        </p>
      </div>
      <UButton
